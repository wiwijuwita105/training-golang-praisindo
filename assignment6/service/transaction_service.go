...
func (s *transactionService) TransferWallet(ctx context.Context, request model.TransferWalletRequest) (model.TransferWalletResponse, error) {
	...
	layout := "2006-01-02T15:04:05Z" // This is the reference format used in Go
	// Convert the dateString into a time.Time object
	date, err := time.Parse(layout, "2024-08-03T14:05:06+07:00")
	if err != nil {
		tx.Rollback()
