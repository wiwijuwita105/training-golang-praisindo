...
import (
	...
	"log"
	"net"
	grpcHandler "session10-crud-user-grpc-gateway/handler/grpc"
	pb "session10-crud-user-grpc-gateway/proto/user_service/v1"
	"session10-crud-user-grpc-gateway/repository/postgres_gorm"
	"session10-crud-user-grpc-gateway/service"
	"time"
...
func main() {
	...
	*/
	...
	log.Println("Running grpc gateway server in port :8181")
	_ = gwServer.Run(":8181")
}
